...
@section('content')
	<div class="card card-primary">
      	...
      	<!-- /.card-header -->
      	<!-- 添加用户 -->
      	<form class="mws-form" action="/admin/friend" method="post" enctype="multipart/form-data">
      		{{ csrf_field() }}
	        <div class="card-body">
	          	<div class="form-group">
	            	<label for="exampleInputEmail1">友情链接名称</label>
	            	<input type="name" class="form-control" placeholder="请输入您的广告标题" name="name" value="{{ old('name') }}">
	          	</div>
	          	<div class="form-group">
	          	...
	          	<div class="form-group">
					<label for="exampleInputPassword1">友情链接标志</label>
