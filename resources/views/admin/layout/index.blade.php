  ...
  <body class="hold-transition sidebar-mini">
    <div class="wrapper">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              <a href="#" class="dropdown-item">
                <!-- Message Start -->
                <div class="media">
                  <img src="/d/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
              ...
              <a href="#" class="dropdown-item">
                <!-- Message Start -->
                <div class="media">
                  <img src="/d/dist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                  <div class="media-body">
              ...
              <a href="#" class="dropdown-item">
                <!-- Message Start -->
                <div class="media">
                  <img src="/d/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                  <div class="media-body">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- 网站LOGO -->
        <a href="http://project.com/admin" class="brand-link">
          <img src="/d/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
          <span class="brand-text font-weight-light">Pornhub</span></a>
        <!-- 左侧导航条开始 -->
        <div class="sidebar">
          <!-- Sidebar user (optional) -->
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
              <img src="/d/dist/img/1.jpg" class="img-circle elevation-2" alt="User Image"></div>
            <div class="info">
              <a href="#" class="d-block">{{ session('user') }}</a></div>
          </div>
          <!-- 分区开始 -->
          <nav class="mt-2">
            <!-- 用户开始 -->
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              <li class="nav-item has-treeview menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="/admin/cates" class="nav-link ">
                      <i class="fa fa-circle-o nav-icon"></i>
                      <p>分类列表</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/admin/cates/create" class="nav-link">
                      <i class="fa fa-circle-o nav-icon"></i>
                      <p>分类添加</p>
                    </a>
                  </li>
              ...
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item has-treeview menu-open">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="/admin/avdert" class="nav-link ">
                        <i class="fa fa-circle-o nav-icon"></i>
                        <p>广告详情</p>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="/admin/avdert/create" class="nav-link">
                        <i class="fa fa-circle-o nav-icon"></i>
                        <p>广告添加</p>
                      </a>
                    </li>
              ...
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item has-treeview menu-open">
                  ...
                  <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                      <a href="/admin/comments/create" class="nav-link">
                        <i class="fa fa-circle-o nav-icon"></i>
                        <p>评论添加</p>
                      </a>
                    </li>
      ...
      <div class="content-wrapper">
        <!-- 读取提示信息 开始 -->@if (session('success'))
        <div class="card card-success">
          <div class="card-header">{{ session('success') }}</div></div>@endif @if (session('error'))
        <div class="card card-error">
          <div class="card-header">{{ session('error') }}</div></div>@endif
        <!-- 显示验证错误信息 开始 -->@if (count($errors) > 0)
        <div class="alert alert-danger">
          <ul>@foreach ($errors->all() as $error)
            <li>{{ $error }}</li>@endforeach</ul></div>@endif
        <!-- 显示验证错误信息 结束 -->
        <!-- 读取提示信息 结束 -->@section('content') @show</div>
      <!-- 内容结束 -->
      <!-- 页脚开始 -->
      <footer class="main-footer">
        <div class="float-right d-none d-sm-block">
          <b>Version</b>3.0.0-alpha</div>
        <strong>Copyright &copy; 2014-2018
          <a href="#">AdminLTE.io</a>.</strong>All rights reserved.</footer>
      <!-- 页脚结束 -->
      <!-- Control Sidebar -->
    ...
    <!-- FastClick -->
    <script src="/d/plugins/fastclick/fastclick.js"></script>
    <!-- AdminLTE App -->
    <script src="/d/dist/js/adminlte.min.js"></script>
    <!-- AdminLTE for demo purposes -->
    <script src="/d/dist/js/demo.js"></script>
  </body>
