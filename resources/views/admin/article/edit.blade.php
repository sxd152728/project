...
<div class="card card-primary">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form role="form" action="/admin/article/{{ $articles->id }}" method="post">{{ csrf_field() }} {{ method_field('PUT')}}
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" value="{{ $articles->title }}" name="title"></div>
            <div class="form-group">
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-primary">
                    <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">确定修改</font></font>
                </button>
            </div>
        </div>
    </form>
